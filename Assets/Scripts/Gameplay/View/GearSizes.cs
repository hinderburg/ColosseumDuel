...
namespace ColosseumDuel.Gameplay.View
{
    ...
    ///
    /// One place for both, because the same sword is drawn twice - lying on the sand and in a
    ...
    /// shortsword at four tenths of a man and a longsword at six, which is about life.
    ///
    ...
    public static class GearSizes
    {
        ...
        public const float GreatswordLength = 2.3f;
        public const float ShieldHeight = 1.2f;
        public const float HelmetHeight = 0.62f;

        public static float WeaponLength(WeaponType type)
            => type == WeaponType.TwoHanded ? GreatswordLength : SwordLength;
