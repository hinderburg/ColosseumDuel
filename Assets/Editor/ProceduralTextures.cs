    ...
    public static class ProceduralTextures
    {
        ...
        private static string[] WeaponIconRows(WeaponKind kind)
        {
            switch (kind)
            {
                ...
                // Scutum: the tall curved shield, one solid slab taller than it is wide.
                case WeaponKind.ScutumAndGladius:
                    return new[]
                    {
                        "................",
                        "...##########...",
                ...
                // Spear: a leaf-shaped head on a long diagonal shaft.
                ...
                // Trident: three points on a crossbar, on a haft.
                case WeaponKind.Trident:
                    return new[]
                    {
                        "................",
                        "..##...##...##..",
